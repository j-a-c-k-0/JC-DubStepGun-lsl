...
default
{
  state_entry()
  {
  llSetLinkPrimitiveParamsFast(getLinkNum("root"),[PRIM_SIZE,<0.01,0.01,0.01>,PRIM_ROT_LOCAL,<0,0,0,0>]);
  ...
  llSetLinkPrimitiveParamsFast(getLinkNum("starget"),[PRIM_POS_LOCAL,<-0.003915,0.198002,-0.052505>,PRIM_SIZE,<0.045128,0.045128,0.047153>,PRIM_ROT_LOCAL,<0.499996,-0.500021,-0.500004,0.499979>]);
  ...
  llSetLinkPrimitiveParamsFast(getLinkNum("gif2"),[PRIM_POS_LOCAL,<-0.003800,0.390600,0.034900>,PRIM_SIZE,<0.055152,0.070808,0.077300>,PRIM_ROT_LOCAL,<0.000000,0.000000,0.000000,1.000000>]);
  ...
  llSetLinkPrimitiveParamsFast(getLinkNum("vinyl"),[PRIM_POS_LOCAL,<-0.003663,0.027296,0.027342>,PRIM_SIZE,<0.05300,0.24730,0.24610>,PRIM_ROT_LOCAL,<0.000000,0.000000,0.000000,1.000000>]);
